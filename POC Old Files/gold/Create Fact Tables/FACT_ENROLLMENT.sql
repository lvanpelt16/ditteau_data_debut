...
CREATE OR REPLACE TABLE DITTEAU_DATA.GOLD.FACT_ENROLLMENT (
    ...
    ENROLLMENT_FIRST_DATE_KEY NUMBER(8,0),
    ENROLLMENT_LATEST_STAT VARCHAR,
    ENROLLMENT_LATEST_DATE_KEY NUMBER(8,0),
    ...
    FOREIGN KEY (ENROLLMENT_FIRST_DATE_KEY) REFERENCES DIM_DATE(DATE_KEY),
    FOREIGN KEY (ENROLLMENT_LATEST_DATE_KEY) REFERENCES DIM_DATE(DATE_KEY)
...
SELECT
    ...
    'Y',
    CURRENT_TIMESTAMP()
FROM DITTEAU_DATA.SILVER.SILVER_CX_CW_REC_ENRICHED a
