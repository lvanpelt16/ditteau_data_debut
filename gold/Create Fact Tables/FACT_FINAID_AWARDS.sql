CREATE OR REPLACE TABLE DITTEAU_DATA.GOLD.FACT_FINANCIAL_AID_AWARDS (
    ...
    FOREIGN KEY (FIN_AID_TERM_KEY) REFERENCES DITTEAU_DATA.GOLD.DIM_AWARDS(AWARD_KEY),
